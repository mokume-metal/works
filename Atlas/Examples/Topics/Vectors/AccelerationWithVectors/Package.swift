...
//
// Processing の `Topics/Vectors/AccelerationWithVectors` を 1 行ずつ移したもの。走らせ方は:
//
//     mokume run .      # 作って走らせる
...
let package = Package(
    name: "AccelerationWithVectors",
    platforms: [.macOS("26.0")],
    products: [.executable(name: "AccelerationWithVectors", targets: ["AccelerationWithVectors"])],
    dependencies: [
