...
//
// Processing の `Topics/Simulate/MultipleParticleSystems` を 1 行ずつ移したもの。走らせ方は:
//
//     mokume run .      # 作って走らせる
...
let package = Package(
    ...
    products: [.executable(name: "MultipleParticleSystems", targets: ["MultipleParticleSystems"])],
    dependencies: [
