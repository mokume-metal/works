...
**8 作品が mokume `v0.7.0` を引いている** ([#21](https://github.com/mokume-metal/works/issues/21))。**Pond と Quarry が `v0.7.1`** で、作った日にそこから解決されたのがその版だった — 残りの追随は [#49](https://github.com/mokume-metal/works/issues/49) が追っている。
