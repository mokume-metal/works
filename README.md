...
**作品 13 本が mokume `v0.9.0` を引いている。** 物差しの [Atlas](Atlas/) だけがまだ `v0.7.0` で、追随は [#49](https://github.com/mokume-metal/works/issues/49) が追っている (157 枚の入れ子パッケージと語彙の台帳を持つので、手順がまるごと違う)。
