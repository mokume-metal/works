...
**上の絵はまだ貼り替えていない。** この 13 本のなかで、彩度の落ち着きが目で見て分かるのはこの作品だけなので貼り替えるべきなのだが、撮り直した絵を上げようとしたところ Gyazo の Upload API が 502 を返し続けた (30 秒おきに 20 回)。貼り替えは [#76](https://github.com/mokume-metal/works/issues/76) が追っている。
